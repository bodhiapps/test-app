...
[![CI](https://github.com/bodhiapps/test-app/actions/workflows/ci.yml/badge.svg)](https://github.com/bodhiapps/test-app/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Deploy](https://github.com/bodhiapps/test-app/actions/workflows/deploy-pages.yml/badge.svg)](https://github.com/bodhiapps/test-app/actions/workflows/deploy-pages.yml)

🚀 **[Live Demo](https://bodhiapps.github.io/test-app/)**
...
git clone https://github.com/bodhiapps/test-app.git
cd test-app
...
Visit `http://localhost:5173/test-app/` to view the app.
...
**Via CLI:**
```bash
gh api -X POST "/repos/bodhiapps/test-app/pages" -f build_type=workflow
```
...
The app is deployed to: `https://bodhiapps.github.io/test-app/`
